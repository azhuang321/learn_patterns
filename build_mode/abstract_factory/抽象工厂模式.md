...
![img](images/abstract-factory-comic-1-zh.png)
...
- 如果你希望了解不同工厂模式和概念之间的区别， 可参阅我们的[工厂模式比较指南](https://refactoringguru.cn/design-patterns/factory-comparison)。