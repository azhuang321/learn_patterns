...
**生成器**是一种创建型设计模式， 使你能够分步骤创建复杂对象。

与其他创建型模式不同， 生成器不要求产品拥有通用接口。 这使得用相同的创建过程生成不同的产品成为可能。

[ 进一步了解生成器模式 ](https://refactoringguru.cn/design-patterns/builder)
...
*根据： [Golang By Example](https://golangbyexample.com/builder-pattern-golang/)*