...
![代理模式解决的问题](images/problem-zh.png)
...
![代理模式的解决方案](images/solution-zh.png)
...
![信用卡是一大捆现金的代理](images/live-example-zh.png)
...
![代理设计模式的结构](images/structure.png)
...
![代理模式示例的结构](images/example-zh.png)
