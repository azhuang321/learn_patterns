...
![GUI 层可以直接访问业务逻辑层](images/solution1-zh.png)
...
![通过命令访问业务逻辑层。](images/solution2-zh.png)
...
![GUI 对象将命令委派给命令对象](images/solution3-zh.png)
...
![命令设计模式的结构](images/structure.png)
